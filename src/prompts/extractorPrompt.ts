...
Instruction:
Read the provided web search context below. Extract the names of the main media works (Movies, Games, Books, TV Shows) mentioned that are most relevant to the user's original intent. Extract up to 5 titles if available.
